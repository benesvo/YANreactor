...
*/
 ...
 //header na seriak pro testovani:
 Serial.println("cas_h; hmotnost_akt; dm; sl_avg; dm_min; error; total_feed; output");
}
...
void loop()
{
  ...
  Serial.print(total_feed); Serial.print(";");
